    ...
    for b in range(0, len(alfabeto)):
        ...
        for a in range(0, len(estado)):
            ...
            for c in range(0, len(transicoes_nfa)):
                ...
                if (
                    estado[a] == transicoes_nfa[c][0]
                    and alfabeto[b] == transicoes_nfa[c][1]
                ):
        ...
        if estado_temp not in estados:
            ...
            calc_estado(
                estado_temp, estados, e_fechos, transicoes_nfa, transicoes_dfa, alfabeto
            )
...
def nfa_e_to_dfa(nfa):
    ...
    automato = Automata(
        def_re, len(estados), estado_inicial, estados_finais, alfabeto, transicoes
    )
